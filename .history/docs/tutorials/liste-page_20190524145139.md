...
Nous allons créer un fichier pour ce service qui aura la signature suivante `function loadCountryListByCriteria({ bodyData, urlData })`
Ensuite nous allons utiliser les paramètres suivants:
