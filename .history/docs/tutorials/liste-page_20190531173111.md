...
Vous pouvez vous reporter au tutorial sur les formulaires afin de voir comment procéder. Ici nous ne metterons pas le formulaire car la logique est strictement identique à celle de création d'un block de détail. Voir [page de détail](./detail-page.md)
