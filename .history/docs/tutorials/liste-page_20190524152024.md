...
export const loadMovieList = movieActions.movielist.load;
// On exporte une fonction pour mettre à jour les élements du store.
export const updateMovieListProperties = movieActions.movielist.updateProperties;
```
