...
Nous allons ici utiliser la page de détail créé dans le tutoriel précédent. Vous pouvez vous reporter au tutorial sur les formulaires afin de voir comment procéder.
