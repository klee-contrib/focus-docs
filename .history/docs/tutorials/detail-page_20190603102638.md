...
Focus propose un store simple [CoreStore]() qui permet de stocker n-noeuds par store. L'idée est que chaque store couvre un thème fonctionnel de l'application.
Par exemple, un store `movieStore` qui aura les noeuds : ``
